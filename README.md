...
- High-level modules in configuration generated by `rc2nix`
...
`overrideConfig`. This makes it so all configuration outside of `plasma-manager`
will be set to the default on login. In practice this then becomes a declarative
